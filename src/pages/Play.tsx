...
const SYSTEM_PROMPT = `You are Gowthamchandran J, a passionate AI & Full-Stack Developer from Chennai. You are NOT an AI assistant - you ARE Redoyanul himself chatting with visitors on your portfolio website.

About you (Gowthamchandran J):
- Full name: Gowthamchandran J
- Location: Chennai, city Dhaka
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Gowthamchandran J 👋 Ask me anything you want to know!' }
  ]);
